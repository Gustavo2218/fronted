    ...
    return (
        ...
        <section class="carousel">
          <div class="carousel__container">
            ...
            <div class="carousel-item">
              <img class="carousel-item__img" src="https://media-cdn.tripadvisor.com/media/photo-s/0b/02/07/7c/fachada-exterior-de-restaurant.jpg" alt=""  />
              <div class="carousel-item__details">
              <div>
              <p class="carousel-item__details--title">Tipicos.</p>
            ...
            <div class="carousel-item">
              <img class="carousel-item__img" src="https://media-cdn.tripadvisor.com/media/photo-s/05/e7/bb/85/ven-y-conocenos.jpg" alt=""  />
              <div class="carousel-item__details">
              <div>
              <p class="carousel-item__details--title">Tipicos.</p>
            ...
            <div class="carousel-item">
              <img class="carousel-item__img" src="https://lh3.googleusercontent.com/proxy/6QCFq6Ft4xinGWNoj0_PsX__xSTB2xKDjNqZsNGbRR36kYOQk1bDcIQxJZTCjuFqKt1yY70UChJPy6O06t9J-W1_7xHFUcwQC6nrYzE5x85QU6cxA28qsKM2RTv_8LN3JjEzfbQHxb-fCM8o" alt=""  />
              <div class="carousel-item__details">
              <div>
              <p class="carousel-item__details--title">Tipicos.</p>
            ...
            <div class="carousel-item">
              <img class="carousel-item__img" src="https://mxcity.mx/wp-content/uploads/2017/01/restaurantes-mexicanos-4.jpg" alt=""  />
              <div class="carousel-item__details">
              <div>
              <p class="carousel-item__details--title">Tipicos.</p>
